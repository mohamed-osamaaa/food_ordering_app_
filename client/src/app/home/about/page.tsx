...
function AboutPage() {
    const features = [
        ...
        },
        {
            ...
            description: "We partner only with top-rated restaurants and verified chefs"
        },
        {
    ...
    const team = [
        ...
        },
        {
            ...
            bio: "Logistics expert who ensures your food arrives fresh and fast"
        },
        {
            name: "Emily Rodriguez",
            role: "Customer Experience",
            bio: "Dedicated to making every order a delightful experience"
        }
    ];
        ...
        <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50">
            ...
            <div className="bg-gradient-to-r from-red-600 to-orange-600 text-white py-20">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <h1 className="text-5xl font-bold mb-4">About ST PIZZA</h1>
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed mb-8">
                            To make great food accessible to everyone, anytime, anywhere. We believe that delicious,
                            quality meals shouldn{"'"}t be limited by location or time constraints. Our platform bridges
                            the gap between passionate chefs and hungry customers, creating a community where food
                        ...
                        <div className="bg-gradient-to-r from-orange-100 to-red-100 rounded-lg p-8">
                            <p className="text-xl font-semibold text-gray-800 italic">
                                ...
                                We{"'"}re here to deliver all three{".\""}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                        <div className="text-center">
                            ...
                            <h3 className="text-xl font-semibold text-gray-800 mb-2">1. Browse & Order</h3>
                            <p className="text-gray-600">Explore hundreds of restaurants near you and place your order with just a few taps</p>
                        </div>
                        <div className="text-center">
                            <div className="w-16 h-16 bg-orange-600 rounded-full mx-auto mb-4 flex items-center justify-center">
                                <ChefHat className="w-8 h-8 text-white" />
                            </div>
                            <h3 className="text-xl font-semibold text-gray-800 mb-2">2. We Prepare</h3>
                            <p className="text-gray-600">Our partner restaurants carefully prepare your meal with fresh, quality ingredients</p>
                        </div>
                        <div className="text-center">
                            <div className="w-16 h-16 bg-red-600 rounded-full mx-auto mb-4 flex items-center justify-center">
                                <Truck className="w-8 h-8 text-white" />
                            </div>
                            <h3 className="text-xl font-semibold text-gray-800 mb-2">3. Fast Delivery</h3>
                            <p className="text-gray-600">Our delivery partners bring your hot, fresh meal directly to your door</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="py-16 bg-gradient-to-r from-orange-600 to-red-600 text-white">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <p className="text-xl mb-8">Join thousands of satisfied customers who trust us with their meals</p>
                    <div className="flex justify-center">
                        <Link className="bg-white text-red-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors" href="/home/menu">
                            ORDER NOW
                        </Link>
                    </div>
                </div>
